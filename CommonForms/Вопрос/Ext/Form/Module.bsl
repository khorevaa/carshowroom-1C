...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе
		...
		ПоказыватьКартинку = БазоваяПодсистемаКлиентСервер.СвойствоСтруктуры(Параметры, "ПоказыватьКартинку", Истина);
	...
	ВыделятьКнопкуПоУмолчанию = БазоваяПодсистемаКлиентСервер.СвойствоСтруктуры(Параметры, "ВыделятьКнопкуПоУмолчанию", Истина);
...
Процедура ПродолжитьОбратныйОтсчет()
	...
	Иначе
		Если ОжиданиеИмяКнопки <> "" Тогда
			НовыйЗаголовок = (ОжиданиеЗаголовокКнопки + " (" + СтрШаблон("осталось %1 сек.", Строка(ОжиданиеСчетчик)) + ")");
