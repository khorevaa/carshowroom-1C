...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	КлючСохраненияПоложенияОкна = "ПредупрежденияПриЗавершенииРаботы" + БазоваяПодсистемаСервер.КонтрольнаяСуммаСтрокой(Ключ);

	ИнициализироватьЭлементыВФорме(Параметры.Предупреждения);
	БазоваяПодсистемаСервер.УстановитьОтображениеЗаголовковГрупп(ЭтотОбъект);
КонецПроцедуры
...
//                        См. СтандартныеПодсистемы.СтандартныеПодсистемы\ПередЗавершениемРаботыСистемы.
//
&НаСервере
