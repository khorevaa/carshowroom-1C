...
Процедура СохранитьНастройкиЭтойФормы()
	...
	БазоваяПодсистемаСервер.ХранилищеНастроекДанныхФормСохранить("СтандартныеПодсистемы.ВариантыОтчетов", "ПанельДругихОтчетов", НастройкиФормы);
КонецПроцедуры
...
Процедура ПрочитатьНастройкиЭтойФормы()
	...
	НастройкиФормы							= БазоваяПодсистемаСервер.ХранилищеОбщихНастроекЗагрузить(ВариантыОтчетовКлиентСервер.ПолноеИмяПодсистемы(), "ПанельДругихОтчетов", НастройкиПоУмолчанию);
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, НастройкиФормы);
КонецПроцедуры

&НаСервере
Функция НастройкиПоУмолчанию()
	Возврат ВариантыОтчетовСервер.ГлобальныеНастройки().ДругиеОтчеты;
КонецФункции
...
Процедура ЗаполнитьПанельОтчетов()
	...
	ОбщиеНастройки		= БазоваяПодсистемаСервер.ОбщиеНастройкиПанели();
...
Функция Подсистемы()
	...
	ДеревоПодсистем	= ВариантыОтчетовСерверПовтИсп.ПодсистемыТекущегоПользователя();
